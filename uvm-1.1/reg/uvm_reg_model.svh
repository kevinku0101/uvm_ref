...
typedef class uvm_reg_array;
typedef class uvm_reg_array_md;
`endif
...
`ifdef UVM_SPARSE_ARRAY
`include "reg/uvm_reg_array.svh"
`include "reg/uvm_reg_array_md.svh"
`endif
