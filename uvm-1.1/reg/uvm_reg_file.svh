...
virtual class uvm_reg_file extends uvm_object;
   ...
   // extern static function uvm_reg_file find_file(input string        name,
   ...
   //
   // Function: get_size
   // Get the size of the uvm_reg_array/uvm_reg_array_md
   //
   ...
   // Get the default register in uvm_reg_array/uvm_reg_array_md
   //

   extern virtual function uvm_reg get_default_reg();

   //
   // Function: Xlock_modelX
   // Lock the uvm_reg_array/uvm_reg_array_md
   //

   extern virtual function void Xlock_modelX();
   `endif
...
function int uvm_reg_file::get_size();
   `uvm_fatal("RegModel","This function should be overridden in uvm_reg_array and uvm_reg_array_md");
endfunction: get_size


// get_default_reg

function uvm_reg uvm_reg_file::get_default_reg();
   `uvm_fatal("RegModel","Function get_default_reg should be overridden in uvm_reg_array and uvm_reg_array_md");
endfunction: get_default_reg


// Xlock_modelX

function void uvm_reg_file::Xlock_modelX();
   `uvm_fatal("RegModel","Function Xlock_modelX should be overridden in uvm_reg_array and uvm_reg_array_md");
