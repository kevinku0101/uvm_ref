...
#ifndef VGCOMMON_RVM_ROOT_SV_UVM_1_1_INCLUDE_UVMC_SNPS_REG_RW_API_H
#define VGCOMMON_RVM_ROOT_SV_UVM_1_1_INCLUDE_UVMC_SNPS_REG_RW_API_H
...
#define SNPS_REG_ADDROF_2D_REG_ARRAY(_type, _name, _size1, _size2, _start_index1, _start_index2, _offset, _incr1, _incr2)          \
    private:                                                                    \
    uint32 __##_name##_id__[_size1][_size2];        \
    public:                                                                     \
    inline snps_reg::reg_map_id _name(int index1, int index2)                       \
    {                                                                           \
                if (__##_name##_id__[index1-_start_index1][index2-_start_index2] == 0) {                                    \
            set_scope();                                                \
            __##_name##_id__[index1-_start_index1][index2-_start_index2] = snps_reg__get_reg_array_id(get_full_name(), #_name,index1, index2, -1); \
        }                                                               \
        snps_reg::reg_map_id addr =                                     \
            {__##_name##_id__[index1-_start_index1][index2-_start_index2], get_context_id()};                       \
        return addr; \
    }
...
#define SNPS_REG_ADDROF_3D_REG_ARRAY(_type, _name, _size1, _size2, _size3, _start_index1, _start_index2, _start_index3, _offset, _incr1, _incr2, _incr3)         \
    private:                                                                    \
    uint32 __##_name##_id__[_size1][_size2][_size3];                                             \
    public:                                                                     \
    inline snps_reg::reg_map_id _name(int index1, int index2, int index3)                       \
    {                                                                           \
                if (__##_name##_id__[index1-_start_index1][index2-_start_index2][index3-_start_index3] == 0) {                                    \
            set_scope();                                                \
            __##_name##_id__[index1-_start_index1][index2-_start_index2][index3-_start_index3] = snps_reg__get_reg_array_id(get_full_name(), #_name,index1, index2, index3); \
        }                                                               \
        snps_reg::reg_map_id addr =                                     \
            {__##_name##_id__[index1-_start_index1][index2-_start_index2][index3-_start_index3], get_context_id()};                       \
        return addr; \
    }
...
#define SNPS_REG_ADDROF_REG_ARRAY_FLD(_type, _reg, _size, _start_index, _name, _offset, _incr) \
    private:                                                                     \
    uint32 __##_reg##_##_name##_id__[_size];                                       \
    public:                                                                      \
...
#define SNPS_REG_ADDROF_2D_REG_ARRAY_FLD(_type, _reg, _size1, _size2, _start_index1, _start_index2, _name, _offset, _incr1, _incr2) \
    private:                                                                     \
    uint32 __##_reg##_##_name##_id__[_size1][_size2];                                       \
    public:                                                                      \
...
#define SNPS_REG_ADDROF_3D_REG_ARRAY_FLD(_type, _reg, _size1, _size2, _size3, _start_index1, _start_index2, _start_index3, _name, _offset, _incr1, _incr2, _incr3) \
    private:                                                                     \
    uint32 __##_reg##_##_name##_id__[_size1][_size2][_size3];                                       \
    public:                                                                      \
