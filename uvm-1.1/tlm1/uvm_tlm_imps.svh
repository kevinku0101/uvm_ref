...
`define UVM_IF_METHOD_BEGIN(req_arg,method_name) \
       ...
       if (obj_size && $cast(__obj__,req_arg)) \
           uvm_default_recorder.port_begin_recording_cb(m_comp,method_name,__obj__,0,0,0,null,0,0,r_tr_h1,r_tr_h2);
`define UVM_IF_METHOD_END(req_arg,method_name) \
       if (obj_size && $cast(__obj__,req_arg)) \
           uvm_default_recorder.port_end_recording_cb(m_comp,method_name,__obj__,r_tr_h1,r_tr_h2);
`define UVM_IF_METHOD2_BEGIN(req_arg,rsp_arg,method_name,has_response,has_return,val) \
       ...
       if (obj_size && $cast(__req__,req_arg) && $cast(__rsp__,rsp_arg)) \
           uvm_default_recorder.port_begin_recording_cb(m_comp,method_name,__req__,0,0,has_response,__rsp__,has_return,val,r_tr_h1,r_tr_h2);
`define UVM_IF_METHOD2_END(req_arg,rsp_arg,method_name,has_response,has_return,val) \
       if (obj_size && $cast(__req__,req_arg) && $cast(__rsp__,rsp_arg)) \
           uvm_default_recorder.port_end_recording_cb(m_comp,method_name,__req__,r_tr_h1,r_tr_h2,0,0,has_response,__rsp__,has_return,val);
