...
`endif
   ...
   function automatic void add_driver_vif_to_sequencer(ref uvm_component connected_drivers[string], input int streamId);
      int num_written_vif = 0;
      foreach (connected_drivers[idx]) begin
         uvm_component verdi_cur_component;
         verdi_cur_component = connected_drivers[idx];
      ...
      do begin
         ...
         if(component_name!=inst_scope_name)
            ...
            if(num_if_written==0 && check_is_sequencer() != 0) begin
               uvm_component connected_drivers[string];
               ...
               if(seqr_port!=null) begin
                  seqr_port.get_provided_to_component(connected_drivers);
