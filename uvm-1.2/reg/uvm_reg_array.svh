...
virtual class uvm_reg_array extends uvm_reg_file;
   ...
   local uvm_reg_addr_t    m_inter_register_offset;
   ...
   extern function void     configure  (uvm_reg_block  blk_parent,
                                        ...
                                        uvm_reg        default_reg,
                                        uvm_reg_addr_t size,
                                        uvm_reg_addr_t inter_register_offset=0,
                                        string         hdl_path = "");
   ...
   //
   extern virtual function void set_inter_register_offset(uvm_reg_addr_t offset);
   ...
   //
   extern local function void            Xcheck_indexX (uvm_reg_addr_t    index,
                                                        string caller);
   ...
   //
   extern local function void            Xbuild_reg_indexX (uvm_reg_addr_t  index);
...
function void uvm_reg_array::configure(uvm_reg_block blk_parent, uvm_reg_file regfile_parent, uvm_reg default_reg, uvm_reg_addr_t size, uvm_reg_addr_t inter_register_offset=0, string hdl_path = "");
...
function void uvm_reg_array::set_inter_register_offset(uvm_reg_addr_t offset);
   if(!m_locked)
...
function uvm_reg uvm_reg_array::get_reg(uvm_reg_addr_t index);
...
function uvm_reg_addr_t uvm_reg_array::calc_inter_reg_offset(uvm_reg_addr_t index, uvm_reg_map map=null);

   uvm_reg_addr_t calculated_offset,multiplier,reg_size,addr_unit_size,min_offset_width;

   `uvm_info("uvm_reg_array",$sformatf("calc_inter_reg_offset called..."),UVM_HIGH)
   ...
   `uvm_info("uvm_reg_array",$sformatf("reg_size=%0d, addr_unit_size=%0d, multiplier=%0d, incr=%0d",reg_size,addr_unit_size,multiplier,m_inter_register_offset),UVM_HIGH)

   if(m_inter_register_offset == 0) begin
   ...
   if(m_inter_register_offset < multiplier) begin
      ...
      calculated_offset = index * m_inter_register_offset;
...
function string uvm_reg_array::set_hdl_path(uvm_reg_addr_t index);

   string hdl_path;
   `uvm_info("uvm_reg_array",$sformatf("set_hdl_path called..."),UVM_HIGH)
   hdl_path = "";
   hdl_path = {hdl_path,$sformatf("[%0d]",index)};
   return hdl_path;
...
function void uvm_reg_array::set(uvm_reg_addr_t  index,
                                 uvm_reg_data_t  value,
                                 string          fname = "",
                                 int             lineno = 0);
...
function uvm_reg_data_t uvm_reg_array::get(uvm_reg_addr_t index,
                                           string         fname = "",
                                           int            lineno = 0);
...
function bit uvm_reg_array::predict (uvm_reg_addr_t    index,
                                     uvm_reg_data_t    value,
                                     uvm_reg_byte_en_t be = -1,
                                     uvm_predict_e     kind = UVM_PREDICT_DIRECT,
                                     uvm_path_e        path = UVM_FRONTDOOR,
...
function void uvm_reg_array::reset(input uvm_reg_addr_t index, string kind = "HARD");
...
function void uvm_reg_array::Xcheck_indexX (uvm_reg_addr_t index,
                                            string         caller);
   if(index >= m_size)
...
function void uvm_reg_array::Xbuild_reg_indexX (uvm_reg_addr_t index);
      uvm_reg_map maps[$];
      ...
      for(int i = 0; i < maps.size ; i++) begin
         ...
         info = new;
         `uvm_info("uvm_reg_array",$sformatf("base_offset=%0d",temp.offset),UVM_HIGH)
         info.offset         = temp.offset + calc_inter_reg_offset(index,maps[i]);
      ...
      begin
         ...
         foreach(paths[i]) begin
            ...
            foreach(temp_slices[k])
               temp_slices[k].path = {temp_slices[k].path,set_hdl_path(index)};
