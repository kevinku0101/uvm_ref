...
class uvm_reg_backdoor extends uvm_object;
   ...
   // Function: allocate
   //
   // Called to create a derived type object.
   //
   extern virtual function uvm_reg_backdoor allocate(uvm_reg_addr_t i);


   // Function: allocate_md
   //
   // Called to create a derived type object.
   //
   extern virtual function uvm_reg_backdoor allocate_md(uvm_reg_addr_t i[]);
...
function uvm_reg_backdoor uvm_reg_backdoor::allocate(uvm_reg_addr_t i);
   `uvm_fatal("RegModel","uvm_reg_backdoor::allocate() not implemented in derivative");
   allocate = null;
...
function uvm_reg_backdoor uvm_reg_backdoor::allocate_md(uvm_reg_addr_t i[]);
   `uvm_fatal("RegModel","uvm_reg_backdoor::allocate_md() not implemented in derivative");
   allocate_md = null;
endfunction: allocate_md
`endif
